...
async function initApp() {
  try {
    ...
    restaurants.forEach(restaurant => {
      const restaurantLon = restaurant.location.coordinates[0]; // longitude
      const restaurantLat = restaurant.location.coordinates[1]; // latitude
      restaurant.distance = calculateDistance(userLat, userLon, restaurantLat, restaurantLon);
    });
    ...
    document.querySelector('body').insertAdjacentHTML(
      'beforeend',
      '<p>Sijainnin hakeminen epäonnistui. Salli sijaintitiedot selaimessa ja lataa sivu uudelleen.</p>'
    );
  }
}

...
// a. sort alphabetically by name and render
...
sortedRestaurants.forEach(renderRestaurant);

// b. exclusive highlight + c. modal with details on click
table.addEventListener('click', (event) => {
  const nameCell = event.target.closest('.restaurant-name');
  if (!nameCell) return;

  // remove highlight from every restaurant name, then add to the clicked one
  document.querySelectorAll('.restaurant-name').forEach((cell) => {
